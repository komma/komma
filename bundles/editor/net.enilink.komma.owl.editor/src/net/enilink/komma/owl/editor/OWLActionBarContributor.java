...
public class OWLActionBarContributor extends EditingDomainActionBarContributor
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(OWLEditorPlugin.INSTANCE
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(OWLEditorPlugin.INSTANCE
				.getString("_UI_OWLEditor_menu"), "owlMenuID");
		...
		//
		createChildMenuManager = new MenuManager(OWLEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(OWLEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(OWLEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
