...
public class ExtensibleLinkedHashSet<E> extends ExtensibleHashSet<E> implements
	 ...
	 */
	public ExtensibleLinkedHashSet(int initialCapacity, float loadFactor) {
	 ...
	 */
	public ExtensibleLinkedHashSet(int initialCapacity) {
	 ...
	 */
	public ExtensibleLinkedHashSet() {
		super(16, .75f, true);
	}
	 ...
	 */
	public ExtensibleLinkedHashSet(Collection<? extends E> c) {
