...
import net.enilink.komma.internal.extensions.ContentFactoriesRegistryReader;
import net.enilink.komma.internal.extensions.ContentHandlerRegistryReader;
import net.enilink.komma.internal.extensions.ExtensionFactoriesRegistryReader;
import net.enilink.komma.internal.extensions.ProtocolFactoriesRegistryReader;
import net.enilink.komma.internal.extensions.URIMappingRegistryReader;
...
public class KommaCore extends AbstractKommaPlugin {
	...
	static public class Implementation extends EclipsePlugin {
		...
		public void start(BundleContext context) throws Exception {
			...
			IModel.Factory.Registry modelFactoryRegistry = KommaCore
			...
			new ContentFactoriesRegistryReader(modelFactoryRegistry)
					.readRegistry();
			new ContentHandlerRegistryReader(KommaCore.getDefault()
					.getContentHandlerRegistry()).readRegistry();
			new URIMappingRegistryReader(KommaCore.getDefault().getURIMap())
					.readRegistry();
		}
	}
	...
	public static KommaModule createModelSetModule(ClassLoader classLoader) {
		...
		for (Class<?> behaviourClass : KommaCore.getModelBehaviours()) {
