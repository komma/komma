...
import net.enilink.komma.internal.repository.change.RepositoryChangeTracker;
...
import net.enilink.komma.sesame.ISesameModelSet;
		...
		if (modelFactoryRegistry == null) {
			modelFactoryRegistry = new ModelFactoryRegistry() {
				...
				protected IModel.Factory delegatedGetFactory(URI uri,
					...
					IModel.Factory.Registry defaultModelFactoryRegistry = KommaCore
						...
						for (Resource changedModel : changedModels) {
							if (changedModel instanceof org.openrdf.model.URI) {
								IModel model = getModel(
										URIImpl
												.createURI(((org.openrdf.model.URI) changedModel)
														.stringValue()), false);
