...
public class FilteredTree {
	...
	private class TreeContentProvider implements ITreeContentProvider {
		...
		/**
		 * Sets new content provider.
		 * 
		 * @param newProvider
		 *            new content provider for the tree, not <code>null</code>
		 */
		public void setProvider(ITreeContentProvider newProvider) {
	 ...
	 */
	public FilteredTree(PatternFilter filter) {
	 ...
	 * @param treeStyle
	 */
	public Control createControl(Composite parent, int treeStyle) {
	...
	protected Control createTreeControl(Composite parent, int style) {
		...
		treeViewer
				.setLabelProvider(treeLabelProvider != null ? treeLabelProvider
						: new LabelProvider());
	...
	protected void createFilterText(Composite parent) {
		...
		// TODO find equivalent which could also be used with RAP
	...
	/**
	 * Sets a new label provider for items in the tree.
	 * 
	 * @param treeLabelProvider
	 *            the label provider for items in the tree
	 */
	public void setTreeLabelProvider(ILabelProvider treeLabelProvider) {
		if (treeViewer != null) {
