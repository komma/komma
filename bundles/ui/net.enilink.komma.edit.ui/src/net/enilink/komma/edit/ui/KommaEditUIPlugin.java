 ...
 */
package net.enilink.komma.edit.ui;
 ...
 * @see #INSTANCE
 */
public final class KommaEditUIPlugin extends AbstractKommaPlugin {
	public static final String PLUGIN_ID = "net.enilink.komma.edit.ui";
	
	/**
	 * The singleton instance of the plugin.
	 */
	public static final KommaEditUIPlugin INSTANCE = new KommaEditUIPlugin();
