...
class InputDialog extends Dialog {
	...
	protected void createButtonsForButtonBar(Composite parent) {
		DialogHelper dialogUtil = DialogHelper.get();

		// create OK and Cancel buttons by default
		okButton = createButton(parent, IDialogConstants.OK_ID, dialogUtil
				.getButtonLabel(IDialogConstants.OK_ID), true);
		createButton(parent, IDialogConstants.CANCEL_ID, dialogUtil
				.getButtonLabel(IDialogConstants.CANCEL_ID), false);
