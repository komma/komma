 ...
 *     Ken Wenzel - adapted TextCellEditor for numeric values
 *******************************************************************************/
...
/**
 * A cell editor that manages a numeric entry field. The cell editor's value is
 * a subclass of <code>Number</code>.
 * <p>
...
public class NumberCellEditor extends CellEditor {
	...
	/**
	 * Default NumberCellEditor style specify no borders on text widget as cell
	 ...
	 *            the parent control
	 */
	public <T extends Number> NumberCellEditor(Composite parent, Class<T> clazz) {
		this(parent, defaultStyle, clazz);
	}
	...
	/**
	 * The <code>NumberCellEditor</code> implementation of this
	 * <code>CellEditor</code> framework method returns the text string.
	 * 
	 * @return the text string
	 */
	protected Object doGetValue() {
		Number number = validValue;

		try {
			number = doConversion(text.getText());

		} catch (NumberFormatException e) {
			MessageBox mbox = new MessageBox(getControl().getShell(),
					SWT.ICON_ERROR | SWT.OK);
			mbox.setText("Fehler");
			mbox.setMessage("Wert '" + text.getText()
					+ "' konnte nicht in Zahl konvertiert werden.\n\n"
	...
	private Number doConversion(String text) throws NumberFormatException {

		if (isNullAllowed && "".equals(text))
			return null;
	...
	protected void doSetValue(Object value) {
		...
		text.setText((validValue == null ? "" : validValue.toString()));
		text.addModifyListener(getModifyListener());
	}
	 ...
	 * <p>
	 * The <code>NumberCellEditor</code> implementation of this framework method
	...
	// Support for RAP applications
	protected static Object invoke(String name, Object object) {
		try {
